...
<head>
    ...
    <title>Thùy Linh Foodie Admin</title>
    <!-- Favicon icon -->
    ...
    ********************-->
    ...
    <div id="main-wrapper">
                    ...
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        <div class="modal-header">
                          <label class="modal-title text-text-bold-600" id="RditProduct">Thay đổi mật khẩu</label>
                                  ...
                                  <div class="row">
                                      <div class="col-sm-3 col-md-6">
                                          <div class="form-group">
                                              <label>VAT (%): </label>
                                              <div class="form-group">
                                                  <input type="text" placeholder="Nhập vào VAT theo phần trăm (%)" value="{{{Auth::user()->tax}}}" class="form-control" name="tax" id="tax">
                                              </div>
                                          </div>
                                      </div>
                                  ...
                                  <div class="row">
                                      ...
                                      <div class="col-sm-3 col-md-6">
                                          <div class="form-group">
                                              ...
                                              <input type="text" placeholder="Đồng tiền" value="{{{Auth::user()->currency}}}" class="form-control" name="currency" id="currency">
                                          </div>
                                      </div>
                                  </div>
                              </div>
                              ...
                              <div class="container col-md-12">
                                <div class="row">
                                  <div class="col-sm-3 col-md-12">
                                     <label>Lấy tọa độ vị trí: </label>
                                    <div class="form-group">
                                        <a href="#" class="badge badge-primary px-2" onclick="getLocation()" >
                                            Bấm vào đây để tự động lấy vị trí của bạn
                                        </a>
                                    </div>
                                  </div>
                                </div>
                        ...
                        <div class="modal-dialog modal-notify modal-info" role="document">
                            ...
                            <div class="modal-content text-center">
                                ...
                                <div class="modal-header d-flex justify-content-center">
                                    <p class="heading">Luôn luôn theo dõi cập nhật</p>
                                </div>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <div class="modal-body">
                  <h5><i class="fa fa-exclamation-triangle" aria-hidden="true"></i> Xin chào</h5>
                    Mừng các bạn đến với Trang quản trị của Thùy Linh nha :
                    <a href="https://facebook.com/thuylinhtranofficial" target="_blank" class="text-danger">Trần Thị Thùy Linh</a>
                    Trang này được quản trị trên PC, hoặc laptop là kết nối tới backend của ứng dụng đặt đồ ăn của Linh</p>
                    <h5><i class="fa fa-shield" aria-hidden="true"></i> ưu điểm là</h5>
                    <p class="mb-0"><i class="fa fa-arrow-right" aria-hidden="true"></i> Dễ quản lý vì là tiếng việt</p>
                    <p class="mb-0"><i class="fa fa-arrow-right" aria-hidden="true"></i> Có ứng dụng doodle trong app</p>
                    <p class="mb-0"><i class="fa fa-arrow-right" aria-hidden="true"></i> Đồ họa đẹp mắt</p>
                    <p><i class="fa fa-arrow-right" aria-hidden="true"></i> Nếu có cần hỗ trợ bạn gửi mail và đánh giá nha</p>
                    <hr>
                  <h5><i class="fa fa-envelope" aria-hidden="true"></i> Liên hệ mình : <a href="mailto:thuylinhlover@gmail.com">thuylinhlover@gmail.com</a></h5>
                </div>
            </div>
          </div>
        </div>
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>&copy; 2021 <a href="https://facebook.com/thuylinhtranofficial" target="_blank">Trần Thị Thùy Linh</a> Quản trị của Ứng dụng đặt đồ ăn.</p>
            </div>
        </div>
        <!--**********************************
            Footer end
