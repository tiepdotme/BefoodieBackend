...
<div class="row page-titles mx-0">
    <div class="col p-md-0">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="javascript:void(0)">Báo cáo và thống kê</a></li>
        </ol>
    </div>
</div>
<!-- row -->
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="example">
                                <h5 class="box-title m-t-30">Lựa chọn khoảng thời gian</h5>
                                ...
                                {{csrf_field()}}
                                    <div class="input-daterange input-group" id="date-range">
                                        ...
                                        <button type="button" class="btn mb-1 btn-flat btn-primary" onclick="GetReport()">Bắt đầu</button>
                                    </div>
                                </form>
                            </div>
                        </div>
