...
<div class="row page-titles mx-0">
    <div class="col p-md-0">
        ...
        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addProduct" data-whatever="@addProduct">Thêm món ăn</button>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="cat_id" class="col-form-label">Danh mục:</label>
                        ...
                        <div class="form-group">
                            <label for="item_name" class="col-form-label">Tên món ăn:</label>
                            <input type="text" class="form-control" name="item_name" id="item_name" placeholder="Tên món ăn">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="delivery_time" id="delivery_time" placeholder="Thời gian vận chuyển">
                        </div>
                        <div class="form-group">
                            <label for="getprice" class="col-form-label">Chi tiết món:</label>
                            <textarea class="form-control" rows="5" name="description" id="description" placeholder="Chi tiết của món ăn"></textarea>
                        </div>
                        <div class="form-group">
                            <label for="colour" class="col-form-label">Chọn hình ảnh cho món ăn:</label>
                        ...
                        <div class="form-group">
                            <label for="colour" class="col-form-label">Chọn các hình ảnh khác cho món ăn:</label>
        ...
        <div class="modal fade" id="EditProduct" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabeledit" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <form method="post" name="editproduct" class="editproduct" id="editproduct" enctype="multipart/form-data">
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabeledit">Chỉnh sửa món ăn</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <span id="emsg"></span>
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="getitem_name" class="col-form-label">Tên món:</label>
                                <input type="text" class="form-control" id="getitem_name" name="item_name" placeholder="Tên món ăn">
                            </div>
                            <div class="form-group">
                                <label for="getprice" class="col-form-label">Giá:</label>
                                <input type="text" class="form-control" name="getprice" id="getprice" placeholder="Giá">
                            </div>
                            <div class="form-group">
                                <label for="getdelivery_time" class="col-form-label">Thời gian vận chuyển:</label>
                                <input type="text" class="form-control" name="getdelivery_time" id="getdelivery_time" placeholder="Thời gian vận chuyển">
                            </div>
                            <div class="form-group">
                                <label for="getprice" class="col-form-label">Chi tiết món:</label>
                                <textarea class="form-control" rows="5" name="getdescription" id="getdescription" placeholder="Chi tiết của món ăn"></textarea>
                            </div>
                        </div>
                        <div class="modal-footer">
...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">tất cả món ăn</h4>
