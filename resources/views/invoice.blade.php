...
<div class="row page-titles mx-0">
    ...
    <div class="col p-md-0">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="javascript:void(0)">Hóa đơn bán hàng</a></li>
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="left strong">
                                ...
                                <div class="cart-addons-wrap">
                                    ...
                                    <div class="cart-addons">
                                        ...
                                        <b>{{$addons['name']}}</b> : {{number_format($addons['price'], 0)}}{{Auth::user()->currency}}
                            ...
                            <td class="left">{{number_format($orders->item_price, 0)}}{{Auth::user()->currency}}</td>

                            <td class="center">{{$orders->qty}}</td>

                            <td class="right">{{number_format($orders->total_price, 0)}}{{Auth::user()->currency}}</td>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="right">
                                    ...
                                    <strong>{{number_format($getusers->tax_amount, 0)}}{{Auth::user()->currency}}</strong>
                            ...
                            <tr>
                                ...
                                <td class="right">
                                    ...
                                    <strong>{{number_format($getusers->delivery_charge, 0)}}{{Auth::user()->currency}}</strong>
                            ...
                            <tr>
                                ...
                                <td class="right">
                                    ...
                                    <strong>{{number_format($getusers->discount_amount, 0)}}{{Auth::user()->currency}}</strong>
                            ...
                            <tr>
                                ...
                                <td class="right">
                                    ...
                                    <strong>{{number_format($getusers->order_total, 0)}}{{Auth::user()->currency}}</strong>
