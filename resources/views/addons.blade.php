...
<div class="row page-titles mx-0">
    <div class="col p-md-0">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="javascript:void(0)">Đồ ăn kèm thêm</a></li>
        </ol>
        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addAddons" data-whatever="@addAddons">Thêm món ăn kèm thêm</button>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Thêm mới đồ ăn kèm thêm</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="cat_id" class="col-form-label">Danh mục món ăn:</label>
                        ...
                        <div class="form-group">
                            <label for="item_id" class="col-form-label">Món:</label>
                            <select name="item_id" class="form-control" id="item_id">
                                
                            </select>
                        </div>
                        <div class="form-group">
                            <label for="name" class="col-form-label">Tên món kèm thêm:</label>
                            <input type="text" class="form-control" name="name" id="name" placeholder="Tên món kèm thêm">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group" id="paid" style="display:none">
                            ...
                            <input type="text" class="form-control" name="price" id="price" placeholder="Giá bao nhiêu">
                        </div>
        ...
        <div class="modal fade" id="EditAddons" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabeledit" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <form method="post" name="editaddons" class="editaddons" id="editaddons" enctype="multipart/form-data">
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabeledit">Chỉnh sửa món kèm thêm</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <span id="emsg"></span>
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="getcat_id" class="col-form-label">Danh mục:</label>
                            ...
                            <div class="form-group">
                                <label for="getname" class="col-form-label">Tên món kèm thêm:</label>
                                <input type="text" class="form-control" name="name" id="getname" placeholder="Tên món kèm thêm">
                            </div>
                            ...
                            <div class="form-group" id="paid">
                                ...
                                <input type="text" class="form-control" name="price" id="getprice" placeholder="Giá">
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btna-secondary" data-dismiss="modal">Tắt</button>
                            @if (env('Environment') == 'sendbox')
...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Tất cả món kèm thêm</h4>
...
function StatusUpdate(id,status) {
    swal({
        title: "Chắc chắn không?",
        text: "bạn có chắc bạn muốn thay đổi trạng thái này ?",
        type: "warning",
        showCancelButton: true,
        confirmButtonClass: "btn-danger",
        confirmButtonText: "Ok đồng ý thay đổi!",
        cancelButtonText: "Không, hủy bỏ tác vụ",
    ...
    function(isConfirm) {
        if (isConfirm) {
            $.ajax({
                ...
                success: function(response) {
                    if (response == 1) {
                        swal({
                            title: "Chấp nhận!",
                            text: "Trạng thái món kèm thêm đã được thay đổi.",
                            type: "success",
                            showCancelButton: true,
                            confirmButtonClass: "btn-danger",
            ...
            swal("Cancelled", "Record này đã được lưu :)", "error");
        }
    });
}
...
function Delete(id) {
    swal({
        ...
        text: "bạn muốn xóa đi món kèm thêm này?",
        type: "warning",
        showCancelButton: true,
        confirmButtonClass: "btn-danger",
        confirmButtonText: "Vâng xóa nó đi",
        cancelButtonText: "Đừng mà để lại nha",
        closeOnConfirm: false,
        closeOnCancel: false,
        showLoaderOnConfirm: true,
    },
    function(isConfirm) {
        if (isConfirm) {
            $.ajax({
                ...
                success: function(response) {
                    if (response == 1) {
                        swal({
                            title: "Chấp nhận!",
                            text: "món kèm thêm đã bị xóa thành công.",
                            type: "success",
                            showCancelButton: true,
                            confirmButtonClass: "btn-danger",
                            confirmButtonText: "Ok",
            ...
            swal("Cancelled", "Record đã được lưu lại :)", "error");
        }
    });
}
