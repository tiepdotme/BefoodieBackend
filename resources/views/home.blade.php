    ...
    <div class="container-fluid mt-3">
        <div class="row">
            <div class="col-lg-3 col-sm-6">
                <div class="card gradient-1">
                    <a href="{{URL::to('/admin/category')}}">
                        <div class="card-body">
                            <h3 class="card-title text-white">Danh mục món</h3>
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="card gradient-2">
                    <a href="{{URL::to('/admin/item')}}">
                        <div class="card-body">
                            <h3 class="card-title text-white">Món ăn</h3>
                            <div class="d-inline-block">
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="card gradient-3">
                    <a href="{{URL::to('/admin/addons')}}">
                        <div class="card-body">
                            <h3 class="card-title text-white">Món kèm thêm</h3>
                            <div class="d-inline-block">
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="card gradient-1">
                    <a href="{{URL::to('/admin/driver')}}">
                        <div class="card-body">
                            <h3 class="card-title text-white">Giao hàng</h3>
                            <div class="d-inline-block">
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="card gradient-2">
                    <a href="{{URL::to('/admin/orders')}}">
                        <div class="card-body">
                            <h3 class="card-title text-white">VAT</h3>
                            <div class="d-inline-block">
                                <h2 class="text-white">{{ number_format($order_tax, 0) }}{{Auth::user()->currency}}</h2>
                            </div>
                ...
                <div class="card gradient-3">
                    <a href="{{URL::to('/admin/orders')}}">
                        <div class="card-body">
                            ...
                            <div class="d-inline-block">
                                <h2 class="text-white">{{ number_format($order_total-$order_tax, 0) }}{{Auth::user()->currency}}</h2>
                            </div>
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="card gradient-4">
                    <a href="{{URL::to('/admin/banner')}}">
                        <div class="card-body">
                            <h3 class="card-title text-white">Hình ảnh Banner</h3>
                            <div class="d-inline-block">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Đơn đặt hàng của ngày hôm nay là</h4>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label for="category_id" class="col-form-label">Đơn hàng số:</label>
                        <input type="text" class="form-control" id="bookId" name="bookId" readonly="">
                    </div>
                    <div class="form-group">
                        <label for="category_id" class="col-form-label">Chọn NV Giao hàng:</label>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" onclick="assign()" data-dismiss="modal">Lưu lại</button>
                </div>
                </form>
            </div>
...
<script type="text/javascript">
    ...
    function DeleteData(id) {
        swal({
            ...
            text: "Bạn đang cố xóa đi đơn hàng này ?",
            type: "warning",
            showCancelButton: true,
            confirmButtonClass: "btn-danger",
            confirmButtonText: "Đúng rồi xóa nó đi",
            cancelButtonText: "Không phải nhầm xíu",
        ...
        function(isConfirm) {
            if (isConfirm) {
                ...
                swal("Cancelled", "Record này đã được giữ lại :)", "error");
            }
        });
    }
